            ...
            <div className='flex h-screen items-center justify-center bg-slate-900'>
                <form onSubmit={handleSubmit(onSubmit)}
                    ...
                    <h1 className='text-2xl text-center'>
                        <span className='text-green-500 font-semibold'> Text App </span>
                    </h1>
                    ...
                    <div className='flex justify-between'>
                        <p className='text-blue-500'>Have an account?
                            <Link to="/" className='text-blue-500 underline cursor-pointer ml-1'>
                                Login
                            </Link>
                        </p>
                        <input type="submit" value="Signup" className='text-white bg-green-500 rounded-lg px-1 py-1 cursor-pointer' />
                    </div>
                </form>
            </div>
        </>
